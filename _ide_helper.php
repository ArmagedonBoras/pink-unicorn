...
')
     ...
     */ 
        ...
        {
                        /** @var \MarvinLabs\Luhn\Algorithm\LuhnAlgorithm $instance */
                        return $instance->isValid($input);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function computeCheckDigit($input)
        {
                        /** @var \MarvinLabs\Luhn\Algorithm\LuhnAlgorithm $instance */
                        return $instance->computeCheckDigit($input);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function computeCheckSum($input)
        {
                        /** @var \MarvinLabs\Luhn\Algorithm\LuhnAlgorithm $instance */
                        return $instance->computeCheckSum($input);
        }
